...
class ServerStateTests(unittest.TestCase):
    ...
    def test_should_update_backend_state(self, now_mock):
        ...
        self.assertEquals({'name': 'web2', 'state': 'healthy', 'timestamp': '2011-09-30T23:00:00Z' }, backend_state)
    ...
    def test_should_update_existing_backend_state(self, now_mock):
        ...
        self.assertEquals({'name': 'web2', 'state': 'sick', 'timestamp': '2011-09-30T23:00:00Z' }, backend_state)
    ...
    def test_should_return_zero_values_for_empty_process(self):
        ...
        self.assertEquals({'virtualmem': '0m', 'reservedmem': '0m', 'cpu': '0.0', 'memory': '0.0'}, process_state)
    ...
    def test_should_update_process_state(self):
        ...
        self.assertEquals({'virtualmem': '410m', 'reservedmem': '109m', 'cpu': '2.0', 'memory': '2.8'}, process_state)
    ...
    def test_should_update_existing_process_state(self):
        ...
        self.assertEquals({'virtualmem': '510m', 'reservedmem': '209m', 'cpu': '3.0', 'memory': '3.8'}, process_state)
    ...
    def test_should_return_all_backends(self, now_mock):
        ...
        expected = {'backends': [{'name': 'web2', 'state': 'healthy', 'timestamp': now}, 
                                 {'name': 'web1', 'state': 'healthy', 'timestamp': now }]}
